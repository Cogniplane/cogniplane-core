...
// at ~/.e2b/config.json so local builds work without additional setup.
...
async function main() {
  // Building under this name repeatedly updates the template in place,
  // preserving its template id.
  await Template.build(template, 'deep-agents-runtime-dev', {
