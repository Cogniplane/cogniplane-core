      ...
      >
        ...
        <fieldset className="flex flex-col gap-2">
          ...
          <p className="text-xs text-on-surface-faint">
            Phase 1 uses <strong className="font-semibold">OpenRouter</strong>, a third-party API. Raw content is sent to
            OpenRouter for inspection in <code className="rounded bg-surface-container px-1 py-0.5 text-[0.7rem]">block</code> and{" "}
            <code className="rounded bg-surface-container px-1 py-0.5 text-[0.7rem]">transform</code> modes. Review{" "}
            <a
              href="https://openrouter.ai/docs/privacy-and-logging"
              rel="noopener noreferrer"
              target="_blank"
              className="text-accent underline-offset-2 hover:underline"
            >
              OpenRouter's data-handling policy
            </a>{" "}
            before enabling.
          </p>
        </fieldset>
